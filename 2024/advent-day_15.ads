...
package Advent.Day_15 is
   type Wide_Tile is (Empty, Wall, Robot, Box, Box_Side);
   subtype Tile is Wide_Tile range Empty .. Box;
   ...
   function Move
     ...
     Pre =>
      ...
      Warehouse (Pos (1), Pos (2)) in Robot .. Box;
   function Move
     (Warehouse : in out Wide_Warehouse_Map; Pos : Position; Dir : Direction)
      return Position with
     Pre =>
      Pos (1) in Warehouse'Range (1) and Pos (2) in Warehouse'Range (2) and
      Warehouse (Pos (1), Pos (2)) in Robot .. Box_Side;
